...
addclient(newclient) {
 ...
 authorizeuser() {
  this.windowHandle = window.open('http://localhost:3333/oauth2/authorize?client_id=XRnnexpe7N&response_type=code&redirect_uri=http://localhost:4200/dashboard');
  var href;
...
getAccessToken() {
  ...
  var tokendata = 'code=' + this.ourcode + '&grant_type=authorization_code&redirect_uri=  ';
